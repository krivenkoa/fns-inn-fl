 ...
 *       &lt;attribute name="DocumentCode" use="required" type="{urn://x-artefacts-fns-inn/commons/4.0.0}SPDULType" />
 *       &lt;attribute name="SeriesNumber" use="required" type="{urn://x-artefacts-fns-inn/commons/4.0.0}SPDULTemplateType" />
 *       &lt;attribute name="IssuerDate" type="{http://www.w3.org/2001/XMLSchema}date" />
 *       &lt;attribute name="Issuer" type="{urn://x-artefacts-fns-inn/commons/4.0.0}string-255" />
 *       &lt;attribute name="IssuerCode" type="{urn://x-artefacts-fns-inn/commons/4.0.0}string-7" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "IdentityDocumentType", namespace = "urn://x-artefacts-fns-inn/commons/4.0.0")
